    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-dash-fg/10 bg-dash-fg/[0.03] p-5">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-dash-fg">Swar Mangal — Founder portal</p>
            <p className="text-xs text-dash-fg/45">Music academy management</p>
          </div>
        </div>
      ...
      <Link
        ...
        className="flex items-center gap-3 rounded-2xl border border-dash-fg/10 bg-dash-fg/[0.03] p-5 transition-colors hover:border-dash-accent/40 hover:bg-dash-accent/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-dash-accent/60"
      >
        <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-dash-accent/10 text-dash-accent">
          <UserCog className="h-5 w-5" aria-hidden />
        </span>
        <div className="min-w-0 flex-1">
          <p className="text-sm font-semibold text-dash-fg">Staff access</p>
          <p className="text-xs text-dash-fg/45">
            Manage authorized emails and issued device tokens
          </p>
        </div>
        <ChevronRight className="h-4 w-4 text-dash-fg/30" aria-hidden />
      </Link>
